...
trait BankReader[Word, Tag] {
  ...
  def wordFromString: (String => Word)
  def tagToString: (Tag => String)
  def tagFromString: (String => Tag)
}

abstract class CcgBankReader[Tag] extends BankReader[String, Tag] {
  ...
  override final val wordToString: (String => String) = identity
  override final val wordFromString: (String => String) = identity
}

abstract class EnglishCcgBankReader[Tag] extends CcgBankReader[Tag] {
...
object PosEnglishCcgBankReader extends EnglishCcgBankReader[String] {
...
abstract class CatEnglishCcgBankReader extends EnglishCcgBankReader[Cat] {
  ...
  override final val startTag = AtomCat("<S>")
  override final val endTag = AtomCat("<E>")
  override final val tagToString: (Cat => String) = _.toString
  override final lazy val tagFromString: (String => Cat) = catmap
}

object FeaturelessEnglishCcgBankReader extends CatEnglishCcgBankReader {
  override protected[this] val catmap = new CatInterner(removeFeatures = true)
}

object FeaturedEnglishCcgBankReader extends CatEnglishCcgBankReader {
  override protected[this] val catmap = new CatInterner(removeFeatures = false)
}
...
abstract class TutCcgBankReader extends BankReader[String, Cat] {
...
object FeaturelessTutCcgBankReader extends TutCcgBankReader {
  override protected[this] val catmap = new CatInterner(removeFeatures = true)
}

object FeaturedTutCcgBankReader extends TutCcgBankReader {
  override protected[this] val catmap = new CatInterner(removeFeatures = false)
}
...
abstract class ChineseCcgBankReader[Tag] extends CcgBankReader[Tag] {
...
abstract class CatChineseCcgBankReader extends ChineseCcgBankReader[Cat] {
  protected[this] def catmap: CatInterner
...
object FeaturelessChineseCcgBankReader extends CatChineseCcgBankReader {
  override protected[this] val catmap = new CatInterner(removeFeatures = true)
}

object FeaturedChineseCcgBankReader extends CatChineseCcgBankReader {
  override protected[this] val catmap = new CatInterner(removeFeatures = false)
}
